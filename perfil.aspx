            ...
            <header class="sombra">
                ...
                <section class="area-user">
                    <div class="id-usuario">
                            <asp:LinkButton ID="linkMeuPerfil" runat="server" OnClick="linkMeuPerfil_Click">
                                <asp:Image ID="imgPerfil" runat="server" ImageUrl="images/User.png" CssClass="material-symbols-outlined icone padding 10px text-center" />
                                <asp:Literal ID="litLinkMeuPerfil" runat="server"></asp:Literal>
                            </asp:LinkButton>                        
                    </div>
